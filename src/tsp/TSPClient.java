...
public class TSPClient extends Client<List<Integer>> {
	...
	public static void main(String[] args) throws Exception {
		...
		if(args.length==0) {
			...
			domain = args[0];
			lowerbound = ComputerHelper.boolInputHelper(args[1]);
		...
		client.begin();
		TSPTaskGroup taskgroup = new TSPTaskGroup(CITIES, new ArrayList<Integer>(Arrays.asList(0)), lowerbound);
		List<Integer> value = client.runTaskGroup(taskgroup);
